...
class UIManager:
    ...
    def agregar_transaccion(self):
        ...
        if self.app.transacciones_manager.agregar_transaccion(tipo, monto, categoria_id, descripcion, fecha):
    ...
    def aplicar_filtros(self):
        ...
        tipo = dpg.get_value("filtro_tipo") if dpg.get_value("filtro_tipo") else None
        categoria = dpg.get_value("filtro_categoria") if dpg.get_value("filtro_categoria") else None
        
        fecha_desde = dpg.get_value("filtro_fecha_desde") if dpg.get_value("filtro_fecha_desde") else None
        fecha_hasta = dpg.get_value("filtro_fecha_hasta") if dpg.get_value("filtro_fecha_hasta") else None
    ...
    def agregar_categoria(self):
        ...
        if self.app.categorias_manager.agregar_categoria(nombre, descripcion):
            self.limpiar_formulario_categoria()
            self.actualizar_tabla_categorias()
            self.actualizar_combos_categorias()
            self.mostrar_mensaje("Categoría agregada correctamente")
        else:
            self.mostrar_mensaje("Error al agregar la categoría", error=True)
    ...
    def actualizar_grafico(self):
        ...
        filtro_tipo = dpg.get_value("filtro_grafico_tipo") if dpg.get_value("filtro_grafico_tipo") else None
        
        # Limpiar gráfico existente
        dpg.delete_item("plot_grafico")
        
        if "Categorías (Barras)" in tipo_grafico:
            self.crear_grafico_barras_categorias(filtro_tipo)
        elif "Categorías (Barras Horizontal)" in tipo_grafico:
            self.crear_grafico_barras_categorias_horizontal(filtro_tipo)
        elif "Mensual (Barras)" in tipo_grafico:
            self.crear_grafico_barras_mensual(filtro_tipo)
